...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ElectroBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/TEAM-ELECTRO/ELECTRO"
        )
        ...
        EXTRA_ElectroBot = os.environ.get("EXTRA_ElectroBot", -1001221881562)
