...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sElectro(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [ElectroBot](t.me/ElectroUserbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your ElectroBot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of ElectroBot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your ElectroBot server'
).add_command(
