...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/ITZ-CYBERKING/Electro-ub) to open this 🔥**Lit AF!!**🔥 __ElectroBot__ Repo.. Join channel :- @Electro_updates")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the Electro" + "ツ")
