...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/ElectroSupport)"
        )
    Electro_data = app.get_log()
    Electro_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": Electro_data})
        .json()
        .get("result")
        .get("key")
    )
    Electro_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{Electro_key}) && [RAW PAGE](https://nekobin.com/raw/{Electro_key}) ⚡"
