...
from userbot import *
from Electro Bot.utils import admin_cmd, edit_or_reply, sudo_cmd
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](Team-Electro/Electro )**",
        ...
        "__INFO:Electro Bot:Logged in as 557667062__",
        "__INFO:Electro Bot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
