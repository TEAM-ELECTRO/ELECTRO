...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing ElectroBot`")
        ...
        await asyncio.sleep(2)
        await edit_or_reply(event, "**SAVING OUTPUT TO ElectroBot LOCAL DATABASE**")
        await asyncio.sleep(3.5)
        await edit_or_reply(event, 
            "Your[ElectroBot](https:/t.me/ElectroUserbot) is working Fine...\n       Join @ElectroSupport For Any Help......"
        )
