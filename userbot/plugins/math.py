...
@ElectroBot.on(admin_cmd(pattern="sin ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="cos ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="tan ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="cosec ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="sec ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="cot ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="square ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@ElectroBot.on(admin_cmd(pattern="cube ?(.*)"))
@ElectroBot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
